...
public class Constants : MonoBehaviour {
    ...
    public bool runSingleSpecies = false;
    ...
    public float synapse_difference_threshold = 1f;
    public float bias_difference_threshold = 1f;
    ...
    public bool show_one_species_full = false;
